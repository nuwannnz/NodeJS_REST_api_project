...
export const applyRoutes = (routes: Route[], router: Router, pathPrefix: string) => {
...
export const validatePassword = async (origPassword: string, password: string): Promise<Boolean> => {
